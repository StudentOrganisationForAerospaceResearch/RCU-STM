...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, CONT_CK0_Pin|CONT_CK1_Pin|TC1_NCS_Pin|TC2_NCS_Pin|TC1_NCS_Pin|TC2_NCS_Pin
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, RELAY6_Pin|LED_2_Pin|LED_1_Pin|LED_0_Pin|NOS1_LC_CLK_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : USART1_TX_EN_Pin */
