...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA7     ------> ADC1_IN12
    */
    GPIO_InitStruct.Pin = NOS2_LC_CLK_Pin|NOS2_LC_DATA_Pin|GPIO_PIN_2|GPIO_PIN_3;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA7     ------> ADC1_IN12
    */
    HAL_GPIO_DeInit(GPIOC, NOS2_LC_CLK_Pin|NOS2_LC_DATA_Pin|GPIO_PIN_2|GPIO_PIN_3);
